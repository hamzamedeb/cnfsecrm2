 ...
 * All Rights Reserved.
 * ********************************************************************************** */
include_once dirname(__FILE__) . '/TCPDF_EVENTS.php';
include_once dirname(__FILE__) . '/Frame.php';

class Vtiger_PDF_Events_Generator {
    ...
    function __construct() {
        $this->pdf = new Vtiger_PDF_EVENTS_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
    ...
    function createPageAttestation($isLastPage = false) {
        $pdf = $this->pdf;
...
//            $this->pagerViewer->display($this);
//        }
       // var_dump($margins['bottom']);
    }

    function createPage2($isLastPage = false) {
        $pdf = $this->pdf;
        ...
        $this->contentFrame = new Vtiger_PDF_Frame();
        $this->contentFrame->x = $pdf->GetX();
        $this->contentFrame->y = $pdf->GetY() + 40.0;
    ...
    function createPage3($isLastPage = false) {
        $pdf = $this->pdf;
        ...
        $this->contentFrame = new Vtiger_PDF_Frame();
        $this->contentFrame->x = $pdf->GetX();
        $this->contentFrame->y = $pdf->GetY() + 15.0;
