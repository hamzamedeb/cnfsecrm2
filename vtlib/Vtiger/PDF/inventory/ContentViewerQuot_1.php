...
class Vtiger_PDF_InventoryQuotContentViewer extends Vtiger_PDF_ContentViewer {
...
//unicom_hamza les commentaires pour cacher le tableau 
    ...
    function displayPreLastPage($parent) {
        ...
        /*    foreach ($this->cells as $cellName => $cellWidth) {
          ...
          /*  if (ceil($contentLineY + $contentHeight) > ceil($contentFrame->h + $contentFrame->y)) {
                ...
                $pdf->Image("test/logo/logo-CNFSE.png", 10, 3, $w, $h);
                //fin logo
