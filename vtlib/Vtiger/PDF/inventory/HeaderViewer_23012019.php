...
class Vtiger_PDF_InventoryHeaderViewer extends Vtiger_PDF_HeaderViewer {
    ...
    function display($parent) {
        ...
        if ($this->model) {
            ...
            $offsetY = 8;
            $nom_client = $modelColumn1['Nom client'];            
            $nom_contact = $modelColumn1['Nom contact'];
            $hauteur_nomclient = 40;
            //$adresse_client = $modelColumn1['adresse_client'];
            $pdf->MultiCell(150, 5, $nom_client, 0, 'L', 0, 1, 120, $hauteur_nomclient);
