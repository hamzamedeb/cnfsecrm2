...
class Vtiger_PDF_ListeAvisFavorableHeaderViewer extends Vtiger_PDF_HeaderViewer {
    ...
    function display($parent) {
        ...
        if ($this->model) {
            ...
            for ($j = 0; $j < $nbr_apprenants; $j++) {
                ...
                $civilite = $modelColumn0['info_apprenants'][$j]["salutation"];
                ...
                if ($modelColumn0['info_apprenants'][$j]["date_fin_appr"] == '0000-00-00' || $modelColumn0['info_apprenants'][$j]["date_fin_appr"] == '' || $modelColumn0['info_apprenants'][$j]["date_fin_appr"] == '1970-01-01') {
                ...
                fputs($monfichier, "\n" . "nom " . $nom);
                fclose($monfichier);
                $ticket_examen = $modelColumn0['info_apprenants'][$j]["ticket_examen"];
                ...
                if ($modelColumn0['info_apprenants'][$j]["duree_jour"] != 0) {
                    $nbr_jours = $modelColumn0['info_apprenants'][$j]["duree_jour"];
                } else {
