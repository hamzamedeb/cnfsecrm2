...
class Vtiger_PDF_ListeAttestationsHeaderViewer extends Vtiger_PDF_HeaderViewer {
    ...
    function display($parent) {
        ...
        if ($this->model) {
            ...
            for ($j = 0; $j < $nbr_apprenants; $j++) {
                ...
                if ($modelColumn0['info_apprenants'][$j]["date_start_appr"] == '0000-00-00' || $modelColumn0['info_apprenants'][$j]["date_start_appr"] == '' || $modelColumn0['info_apprenants'][$j]["date_start_appr"] == '1970-01-01') {
                ...
                if ($modelColumn0['info_apprenants'][$j]["date_fin_appr"] == '0000-00-00' || $modelColumn0['info_apprenants'][$j]["date_start_appr"] == '' || $modelColumn0['info_apprenants'][$j]["date_start_appr"] == '1970-01-01') {
                ...
                if ($modelColumn0['info_apprenants'][$j]["duree_heure"] == 0) {
                    $nbr_heure = $modelColumn0["nbr_heures"];
                } else {
                    $nbr_heure = $modelColumn0['info_apprenants'][$j]["duree_heure"];
                }
                if ($modelColumn0['info_apprenants'][$j]["duree_jour"] == 0) {
                    $nbr_jour = $modelColumn0["nbr_jours"];
                } else {
                    $nbr_jour = $modelColumn0['info_apprenants'][$j]["duree_jour"];
                }
                ...
                $salutation = $modelColumn0['getApprenants'][$j]["salutation"];
                $prenom = $modelColumn0['getApprenants'][$j]["firstname"];
                $nom = $modelColumn0['getApprenants'][$j]["lastname"];
                $datenaissance = $modelColumn0['getApprenants'][$j]["birthday"];
                $date = "contacts-birthday";
                $resultat = $modelColumn0['info_apprenants'][$j]["resultat"];
                switch ($resultat) {
                    case "avis_favorable":
                ...
                $be_essai = $modelColumn0['info_apprenants'][$j]["be_essai"];
                $be_mesurage = $modelColumn0['info_apprenants'][$j]["be_mesurage"];
                $be_verification = $modelColumn0['info_apprenants'][$j]["be_verification"];
                $be_manoeuvre = $modelColumn0['info_apprenants'][$j]["be_manoeuvre"];
                $he_essai = $modelColumn0['info_apprenants'][$j]["he_essai"];
                $he_mesurage = $modelColumn0['info_apprenants'][$j]["he_mesurage"];
                $he_verification = $modelColumn0['info_apprenants'][$j]["he_verification"];
                $he_manoeuvre = $modelColumn0['info_apprenants'][$j]["he_manoeuvre"];
                $initiale = $modelColumn0['info_apprenants'][$j]["initiale"];
                $recyclage = $modelColumn0['info_apprenants'][$j]["recyclage"];
                $testprerequis = $modelColumn0['info_apprenants'][$j]["testprerequis"];
                $electricien = $modelColumn0['info_apprenants'][$j]["electricien"];
...
//fin image
                ...
                //$pdf->writeHTML($text, true, false, true, false, 'L');
