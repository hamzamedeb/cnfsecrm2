...
class Vtiger_PDF_ListeTOKENSTESTHeaderViewer extends Vtiger_PDF_HeaderViewer {
    ...
    function display($parent) {
        ...
        if ($this->model) {
            ...
            $pdf->MultiCell(210, 5, 'Liste des Tickets Examen Test', '', 'C', 0, 1);
            ...
            for ($i = 0; $i < $nombre_apprenant; $i++) {
                ...
                $typeticketexamentest = $modelColumn0['info_apprenants'][$i]['type_tokens_test'];
                $ticketexamentest = $modelColumn0['info_apprenants'][$i]['ticket_examen_test'];
                $tableau1 .= '<tr>
                                ...
                                <td align="center" style="height:30px;width:120px;">' . $typeticketexamentest . '</td>
                                <td align="center" style="height:30px;width:100px;">' . $ticketexamentest . '</td>                                
                            </tr>';
            }
            $tableau1 .= '</table>';
