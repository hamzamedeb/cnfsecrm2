...
<div class="details block">
    <div class="lineItemTableDiv">
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            <thead>
            <th colspan="{$COL_SPAN1 + 3}" class="lineItemBlockHeader">
            ...
            <tbody>
                ...
                <td class="lineItemBlockHeader">
               <strong> {vtranslate('TARIF', $MODULE_NAME)}</strong>
            </td>    
                    <td class="lineItemBlockHeader">
                <strong>{vtranslate('LBL_NBR_JOURS', $MODULE_NAME)}</strong>
            </td>
            <td class="lineItemBlockHeader">
               <strong> {vtranslate('LBL_NBR_HEURES', $MODULE_NAME)}</strong>
            </td>
            <td class="lineItemBlockHeader">
                ...
                {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                    <tr>
                        ...
                        <td>
                            <div align = "center">{$LINE_ITEM_DETAIL["tarif$INDEX"]}</div>
                            <div align = "center">Base H {$LINE_ITEM_DETAIL["base_heure$INDEX"]}</div>
                        </td>
                            <td>
                            <div align = "center">{$LINE_ITEM_DETAIL["nbr_jours$INDEX"]}</div>
                        </td>
                        <td>
                            <div align = "center">{$LINE_ITEM_DETAIL["nbr_heures$INDEX"]}</div>
                        </td>
                        <td>
                            <div align = "center">{$LINE_ITEM_DETAIL["qty$INDEX"]}</div>
                        </td>
                        ...
                        <td>
                            ...
                            {/if}
                            <div align = "right" class="hide">{$LINE_ITEM_DETAIL["totalAfterDiscount$INDEX"]}</div>
                            {if $FINAL_DETAILS.taxtype neq 'group'}
    ...
    <table class="table table-bordered lineItemsTable">
        ...
        {if $MODULE_NAME eq 'Invoice' or $MODULE_NAME eq 'SalesOrder'}
            <tr valign="top">
                <td width="83%" >
                        <div class="pull-right">
                                {vtranslate('LBL_FINANCEMENT',$MODULE)}
                        </div>
                </td>
                <td>
                    <div align="right">{if !empty($FINAL_DETAILS.financement)}{$FINAL_DETAILS.financement}{else}0{/if}</div>
                </td>
            </tr>
            {if $MODULE_NAME eq 'Invoice'}
                <tr valign="top">
                    <td width="83%" >
                            <div class="pull-right">
                                   {vtranslate('LBL_MONTANTCLIENT',$MODULE)}
                            </div>
                    </td>
                    <td>
                            <div align="right">{if !empty($FINAL_DETAILS.montantclient)}{$FINAL_DETAILS.montantclient}{else}0{/if}</div>
                    </td>
                </tr>
            {/if}
        {/if}
        ...
        {if $SH_PERCENT_VIEWABLE or $MODULE_NAME eq 'Quotes'}
