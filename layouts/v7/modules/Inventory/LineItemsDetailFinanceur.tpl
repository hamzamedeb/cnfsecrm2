    ...
    <div class="lineItemTableDiv">
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <tr>
                ...
                <th class="lineItemBlockHeader">Identité</th>
            ...
            <tbody>
                {foreach key=INDEX item=LINE_FINANCEURS_DETAIL from=$RELATED_FINANCEURS}
                <tr>
                    ...
                    <td>{$LINE_FINANCEURS_DETAIL["vendor_no$INDEX"]}</td>
                    <td>{$LINE_FINANCEURS_DETAIL["adresse$INDEX"]}</td>
                    <td>{$LINE_FINANCEURS_DETAIL["code_postal$INDEX"]}</td>
                    <td>{$LINE_FINANCEURS_DETAIL["ville$INDEX"]}</td>
                    <td>{$LINE_FINANCEURS_DETAIL["telephone$INDEX"]}</td>
                </tr>
                {/foreach}
            </tbody>
        </table>
