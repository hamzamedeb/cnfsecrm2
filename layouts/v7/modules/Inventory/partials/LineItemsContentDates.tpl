...
<td class="fieldLabelNeeds medium">
                ...
                <td class="fieldValue medium">
                    <div>
                        <span class="span10">
                            <div>
                                <div class="input-append row-fluid"><div class="span12 row-fluid date">
                                        <input id="{$start_matin}" type="text" value="{if !empty($data.$start_matin)}{$data.$start_matin}{else}09:30{/if}" data-format="24" name="{$start_matin}" class="start_matin timepicker-default input-small ui-timepicker-input smallInputBox inputElement" autocomplete="off">
                ...
                <td class="fieldLabelNeeds medium">
                    <label class="muted pull-right marginRight10px">
                        <span class="redColor">*</span>Durée
                    </label>
                </td>
                <td class="fieldValue medium">
                    <div>
