         ...
         {if $BLOCK_FIELDS|@count gt 0}
             <div class='fieldBlockContainer' data-block="{$BLOCK_LABEL}">
                 ...
                 <table class="table table-borderless {if $BLOCK_LABEL eq 'LBL_ADDRESS_INFORMATION'} addressBlock{/if}">
                     {* uni_cnfsecrm - hide bloc copier adresse *}
                     {if ($BLOCK_LABEL eq 'LBL_ADDRESS_INFORMATION') and ($MODULE neq 'SalesOrder') and ($MODULE neq 'Quotes') and ($MODULE neq 'Invoice')}
                        <tr>
...
{include file="partials/LineItemsEditDates.tpl"|@vtemplate_path:'Inventory'}  
{include file="partials/LineItemsEditApprenants.tpl"|@vtemplate_path:'Inventory'}        
{include file="partials/LineItemsEdit.tpl"|@vtemplate_path:'Inventory'}
{if $MODULE_NAME eq 'SalesOrder' or $MODULE_NAME eq 'Invoice'}
    {include file="partials/LineItemsEditFinanceur.tpl"|@vtemplate_path:'Inventory'} 
{/if}