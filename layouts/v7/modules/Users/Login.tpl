	...
	<div class="col-lg-12">
		<div class="col-lg-5">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="test/logo/logo-CNFSE.png">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue">Se connecter</button><br>
							<a class="forgotPasswordLink" style="color: #15c;">Mot de passe oublié ?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">Valider</button><br>
							<span>S'il vous plaît entrer les détails et valider<a class="forgotPasswordLink pull-right" style="color: #15c;">Retour</a></span>
						</div>
					</form>
				</div>
			</div>
