{strip}
	...
	{/foreach}
        ...
        <div class="block block_detailHistoriqueId" data-block="detailHistoryarrivageId" data-blockid="detailHistoryarrivageId">
			<div>
				<h4 class="textOverflowEllipsis maxWidth50">
					<img class="cursorPointer alignMiddle blockToggle {if !($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowRight.png')}" data-mode="hide" data-id=detailHistoryarrivageId>
					<img class="cursorPointer alignMiddle blockToggle {if ($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowdown.png')}" data-mode="show" data-id=detailHistoryarrivageId>&nbsp;
					Historique
				</h4>
			</div>
			<hr>
