...
<div class="dashboardWidgetHeader clearfix">
    ...
    <div class="title">
        ...
        <div class="dashboardTitle" title="{vtranslate($WIDGET->getTitle(), $MODULE_NAME)}"><b>Rappel Apprenant Recyclage</b> (Nombre des apprenants à rappeler {$DATA['nbreAppr']})</div>
        {* uni_cnfsecrm - v2 - modif 114 - FIN *}
    </div>    
        <div class="userList">
            <select name="filterList" id="filterListRecyclage" class="form-control select2 widgetFilter col-lg-3 reloadOnChange select2-offscreen">
...
<div name="history" class="dashboardWidgetContent" style="padding-top:15px;">
    {include file="dashboards/RappelApprenantRecyclageContents.tpl"|@vtemplate_path:$MODULE_NAME WIDGET=$WIDGET}
</div>