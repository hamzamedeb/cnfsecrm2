...
{strip}
	...
	{include file="partials/EditViewContents_block1.tpl"|@vtemplate_path:'Events'}                      
        {include file="partials/LineItemsEditDates.tpl"|@vtemplate_path:'Events'}  
        {* uni_cnfsecrm - v2 - modif 177 - DEBUT  *}
        <input type="file" name="file" class="file"><br/>
        <input type="button" value="Import Apprenant via Excel" name="Import Apprenant via Excel" id="importExcel" class="btn btn-primary" >
        {* uni_cnfsecrm - v2 - modif 177 - DEBUT *}
        {include file="partials/LineItemsEditApprenants.tpl"|@vtemplate_path:'Events'}                
        {include file="partials/EditViewContents_block2.tpl"|@vtemplate_path:'Events'}  
        <br/>
