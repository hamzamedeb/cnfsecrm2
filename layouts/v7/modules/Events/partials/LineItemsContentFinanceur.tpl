    ...
    <span class="span10">
        <div>            
            <div class="input-append row-fluid"><div class="span12 row-fluid"> 
                    <input id="{$pourcentage}" type="text" value="{$data.$pourcentage}" class="pourcentage smallInputBox inputElement" name="{$pourcentage}" style="width: 100px">  
                </div>
            </div>
        </div>
    </span>
...
<div>
    <span class="span10">
        <div>            
            <div class="input-append row-fluid"><div class="span12 row-fluid"> 
                    <input id="{$montant}" type="text" value="{$data.$montant}" class="montant smallInputBox inputElement" name="{$montant}" style="width: 100px">  
                </div>
            </div>
        </div>
    </span>
...
<div>
    <span class="span10">
        <div>            
            <div class="input-append row-fluid"><div class="span12 row-fluid"> 
                    <input id="{$tva}" type="text" value="{$data.$tva}" class="tva smallInputBox inputElement" name="{$tva}" style="width: 100px">  
                </div>
            </div>
        </div>
    </span>
...
<div>
    <span class="span10">
        <div>            
            <div class="input-append row-fluid"><div class="span12 row-fluid"> 
                    <input id="{$ttc}" type="text" value="{$data.$ttc}" class="ttc smallInputBox inputElement" name="{$ttc}" style="width: 100px">  
                </div>
            </div>
        </div>
    </span>
