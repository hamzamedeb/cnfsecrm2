            ...
            <div class = "quickPreviewSummary">
                ...
                <table class="table" id="tableAction">
                    ...
                    <tr id="rowNew">
                        ...
                        <td class="reponseTd">
                            <select onchange="HistorySansSessions_Edit_Js.selectReponse(event,'')" class="form-control reponse">
                        ...
                        <td>
                            <button style="font-size: 20px;" class="btn btn-success pull-right" id="addRow" onclick="HistorySansSessions_Edit_Js.addEditRow('save','')">+</button> 
                        </td>
                    </tr>
                </table>
                ...
                <table id="tableData" class="table">
                    {foreach item=FIELD_MODEL key=FIELD_NAME from=$DETAIL_HISTORIQUE}
                        <tr id="reponse{$FIELD_MODEL['id']}">
                            ...
                            <td><span onclick="HistorySansSessions_Edit_Js.editRow({$FIELD_MODEL['id']})" class="fa fa-pencil"></span></td>
                        </tr>
                        <tr id="reponseedit{$FIELD_MODEL['id']}" class="hidden">
                            <td>
                                <input type="input" value="{$FIELD_MODEL['date']}" data-date-format="dd-mm-yyyy" class="form-control dateField dateRappel" />
                            </td>
                            <td class="reponseTd">
                                <select onchange="HistorySansSessions_Edit_Js.selectReponse(event, {$FIELD_MODEL['id']})" class="form-control reponse">
                            ...
                            <td> <span onclick="HistorySansSessions_Edit_Js.addEditRow('edit', {$FIELD_MODEL['id']})" class="pointerCursorOnHover input-group-addon input-group-addon-save"><i class="fa fa-check"></i></span> </td>
                            <td> <span onclick="HistorySansSessions_Edit_Js.annulerEditRow({$FIELD_MODEL['id']})" class="pointerCursorOnHover input-group-addon input-group-addon-cancel"><i class="fa fa-close"></i></span> </td>
                        </tr>
                    {/foreach}
                </table>
            </div>
