...
{strip}
	...
	{/foreach}
        ...
        <div class="block block_detailHistoriqueId" data-block="detailHistorysanssessionId" data-blockid="detailHistorysanssessionId">
			<div>
				<h4 class="textOverflowEllipsis maxWidth50">
					<img class="cursorPointer alignMiddle blockToggle {if !($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowRight.png')}" data-mode="hide" data-id=detailHistorysanssessionId>
					<img class="cursorPointer alignMiddle blockToggle {if ($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowdown.png')}" data-mode="show" data-id=detailHistorysanssessionId>&nbsp;
					Historique
				</h4>
			</div>
			<hr>
