...
<div class="col-sm-12 col-xs-12 ">
								...
								<span class="value">
									...
									{else}
										{if $LISTVIEW_HEADER->get('uitype') eq '72'}
											...
											<span style='color:{$LISTVIEW_ENTRY->getCollor($LISTVIEW_HEADERNAME)};'>
	...
	<div align="center" class="" style="color: rgb(153, 153, 153);">{vtranslate("Cashflow4You","Cashflow4You")} {$VERSION} {vtranslate("COPYRIGHT","Cashflow4You")}</div>
</div>