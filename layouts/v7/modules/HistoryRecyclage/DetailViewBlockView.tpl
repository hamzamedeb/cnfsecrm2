...
{strip}
	...
	{/foreach}
        ...
        <div class="block block_detailHistoriqueId" data-block="detailHistoryrecyclageId" data-blockid="detailHistoryrecyclageId">
			<div>
				<h4 class="textOverflowEllipsis maxWidth50">
					<img class="cursorPointer alignMiddle blockToggle {if !($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowRight.png')}" data-mode="hide" data-id=detailHistoryrecyclageId>
					<img class="cursorPointer alignMiddle blockToggle {if ($IS_HIDDEN)} hide {/if}" src="{vimage_path('arrowdown.png')}" data-mode="show" data-id=detailHistoryrecyclageId>&nbsp;
					Historique
				</h4>
			</div>
			<hr>
                            ...
                            <table style="width: 100%;text-align: center;" class="table-bordered detailview-table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="height: 30px; text-align: center;">Réponse</th>
