...
-->*}
{strip}
    {* uni_cnfsecrm - v2 - modif 171  FILE *}
    ...
    {* uni_cnfsecrm - v2 - modif 170 - DEBUT *}
    <div class="col-lg-6 detailViewButtoncontainer" style="padding-top: 10px; padding-right: 193px">
         <div class="pull-right btn-toolbar">
            <div class="btn-group">
                <button class="btn btn-default" id="" onclick="window.location.href = 'index.php?module=Cashflow4You&view=Edit&relationid={$RECORD->getId()}&sourceModule=Invoice&relationOperation=1&sourceRecord={$RECORD->getId()}&app=INVENTORY'">Générer réglement</button>
                {* uni_cnfsecrm - v2 - modif 175 - DEBUT *}
                <button class="btn btn-default" id="createAvoirFacture" onclick="window.location.href = 'index.php?module=Invoice&view=Edit&record={$RECORD->getId()}&isDuplicate=true&isAvoir=true&app=INVENTORY'">Générer Avoir</button>
                {* uni_cnfsecrm - v2 - modif 175 - FIN *}
                <button class="btn btn-default" id="" onclick="window.location.href = 'index.php?module=Invoice&view=Edit&record={$RECORD->getId()}&isDuplicate=true&retro=true&app=INVENTORY'">Rétro</button>
            </div>
        </div>
    </div>
    {* uni_cnfsecrm - v2 - modif 170 - FIN *}
