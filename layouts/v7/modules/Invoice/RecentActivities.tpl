        ...
        <div class='history'>
            ...
            {else}
                    ...
                    <ul class="updates_timeline">
                        <li>
                            <time class="update_time cursorDefault">
                                <small title="{Vtiger_Util_Helper::formatDateTimeIntoDayString($RECENT_ACTIVITIES_INVOICE['createdtime'])}">
                                    {Vtiger_Util_Helper::formatDateDiffInStrings($RECENT_ACTIVITIES_INVOICE['createdtime'])}
                                </small>
                            </time>
                                <div class="update_icon bg-info">
                                    <i class='update_image vicon-vtigeruser'></i>
                            ...
                            <div class="update_info">
                                <h5>
                                    <span class="field-name">{$RECENT_ACTIVITIES_INVOICE['nom']}</span> {vtranslate('LBL_CREATED', $MODULE_NAME)}
                                </h5>
                            </div>
                        </li>
                    </ul>    
