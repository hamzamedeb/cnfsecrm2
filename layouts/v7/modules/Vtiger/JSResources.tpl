...
{strip}
    ...
    {/foreach}
    <!-- uni_cnfsecrm -->    
    {if $smarty.get.module eq 'Calendar' && $smarty.get.view eq 'Detail'} 
        <script type="text/javascript" src="{vresource_url('layouts/v7/modules/Events/resources/Detail.js')}"></script>   
    {/if}
