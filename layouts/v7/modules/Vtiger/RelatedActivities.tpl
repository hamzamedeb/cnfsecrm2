		...
		<div class="widget_header clearfix">
			...
			<div class="pull-right" style="margin-top: -5px;">
				{if $CALENDAR_MODEL->isPermitted('CreateView')}
                                        <div class="btn-group">
                                            <button type="button" module="Calendar" class="btn btn-default selectRelation" data-modulename="Calendar">
                                                {vtranslate('LBL_SELECT_SESSION',$MODULE_NAME)}
                                            </button>
                                            {* uni_cnfsecrm *}
                                            <input type="hidden" name="relatedModuleName" class="relatedModuleName" value="Calendar">
                                            <input type="hidden" name="relationId" class="relationId" value="72">
                                        </div>                                        
