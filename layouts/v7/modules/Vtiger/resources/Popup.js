...
//						}
    ...
    registerSelectAvisAttestationButton: function () {
        var popupPageContentsContainer = jQuery('#popupPageContainer');
        var thisInstance = this;

        popupPageContentsContainer.on('click', '.selectAvisAttestation', function (e) {
            e.preventDefault();
...
//                        var id = selectedRecords[data]['id'];
            ...
            var be_essai = jQuery('#be_essai');
            var be_mesurage = jQuery('#be_mesurage');
            var be_verification = jQuery('#be_verification');
            var be_manoeuvre = jQuery('#be_manoeuvre');
            var he_essai = jQuery('#he_essai');
            var he_mesurage = jQuery('#he_mesurage');
            var he_verification = jQuery('#he_verification');
            var he_manoeuvre = jQuery('#he_manoeuvre');
            var resultat = jQuery('#resultat');
            var initiale = jQuery('#initiale');
            var recyclage = jQuery('#recyclage');
            var testprerequis = jQuery('#testprerequis');
            var electricien_oui = jQuery('#electricien_oui');
            var electricien_non = jQuery('#electricien_non');
            var testprerequis_oui = jQuery('#testprerequis_oui');
            var testprerequis_non = jQuery('#testprerequis_non');
            if (be_essai.is(':checked')) {
                console.log("checked");
                jQuery('#be_essai' + row_num).prop('checked', true);
            } else {
                console.log(" not checked");
                jQuery('#be_essai' + row_num).prop('checked', false);
            }

            if (be_mesurage.is(':checked')) {
                jQuery('#be_mesurage' + row_num).prop('checked', true);
            } else {
                jQuery('#be_mesurage' + row_num).prop('checked', false);
            }

            if (be_verification.is(':checked')) {
                console.log("be_verification checked");
                jQuery('#be_verification' + row_num).prop('checked', true);
            } else {
                console.log("be_verification not checked");
                jQuery('#be_verification' + row_num).prop('checked', false);
            }

            if (be_manoeuvre.is(':checked')) {
                jQuery('#be_manoeuvre' + row_num).prop('checked', true);
            } else {
                jQuery('#be_manoeuvre' + row_num).prop('checked', false);
            }

            if (he_essai.is(':checked')) {
                jQuery('#he_essai' + row_num).prop('checked', true);
            } else {
                jQuery('#he_essai' + row_num).prop('checked', false);
            }

            if (he_mesurage.is(':checked')) {
                jQuery('#he_mesurage' + row_num).prop('checked', true);
            } else {
                jQuery('#he_mesurage' + row_num).prop('checked', false);
            }

            if (he_verification.is(':checked')) {
                jQuery('#he_verification' + row_num).prop('checked', true);
            } else {
                jQuery('#he_verification' + row_num).prop('checked', false);
            }

            jQuery('#resultat' + row_num).val(resultat.val());

            if (he_manoeuvre.is(':checked')) {
                jQuery('#he_manoeuvre' + row_num).prop('checked', true);
            } else {
                jQuery('#he_manoeuvre' + row_num).prop('checked', false);
            }

            if (initiale.is(':checked')) {
                jQuery('#initiale' + row_num).prop('checked', true);
            } else {
                jQuery('#initiale' + row_num).prop('checked', false);
            }

            if (recyclage.is(':checked')) {
                jQuery('#recyclage' + row_num).prop('checked', true);
            } else {
                jQuery('#recyclage' + row_num).prop('checked', false);
            }

            if (testprerequis_oui.is(':checked')) {
                jQuery('#testprerequis_oui' + row_num).prop('checked', true);
            } else if (testprerequis_non.is(':checked')) {
                jQuery('#testprerequis_non' + row_num).prop('checked', true);
            }

            if (electricien_oui.is(':checked')) {
                jQuery('#electricien_oui' + row_num).prop('checked', true);
            } else if (electricien_non.is(':checked')) {
                jQuery('#electricien_non' + row_num).prop('checked', true);
            }

// uni_cnfsecrm - modif 104 - DEBUT 
            var b0_h0_h0v_b0 = $('#b0_h0_h0v_b0');
            var b0_h0_h0v_h0v = $('#b0_h0_h0v_h0v');
            var bs_be_he_b0 = $('#bs_be_he_b0');
            var bs_be_he_h0v = $('#bs_be_he_h0v');
            var bs_be_he_bs = $('#bs_be_he_bs');
            var bs_be_he_manoeuvre = $('#bs_be_he_manoeuvre');
            var b1v_b2v_bc_br_b0 = $('#b1v_b2v_bc_br_b0');
            var b1v_b2v_bc_br_h0v = $('#b1v_b2v_bc_br_h0v');
            var b1v_b2v_bc_br_bs = $('#b1v_b2v_bc_br_bs');
            var b1v_b2v_bc_br_manoeuvre = $('#b1v_b2v_bc_br_manoeuvre');
            var b1v_b2v_bc_br_b1v = $('#b1v_b2v_bc_br_b1v');
            var b1v_b2v_bc_br_b2v = $('#b1v_b2v_bc_br_b2v');
            var b1v_b2v_bc_br_bc = $('#b1v_b2v_bc_br_bc');
            var b1v_b2v_bc_br_br = $('#b1v_b2v_bc_br_br');
            var b1v_b2v_bc_br_essai = $('#b1v_b2v_bc_br_essai');
            var b1v_b2v_bc_br_verification = $('#b1v_b2v_bc_br_verification');
            var b1v_b2v_bc_br_mesurage = $('#b1v_b2v_bc_br_mesurage');
            var b1v_b2v_bc_br_h1v_h2v_b0 = $('#b1v_b2v_bc_br_h1v_h2v_b0');
            var b1v_b2v_bc_br_h1v_h2v_h0v = $('#b1v_b2v_bc_br_h1v_h2v_h0v');
            var b1v_b2v_bc_br_h1v_h2v_bs = $('#b1v_b2v_bc_br_h1v_h2v_bs');
            var b1v_b2v_bc_br_h1v_h2v_manoeuvre = $('#b1v_b2v_bc_br_h1v_h2v_manoeuvre');
            var b1v_b2v_bc_br_h1v_h2v_b1v = $('#b1v_b2v_bc_br_h1v_h2v_b1v');
            var b1v_b2v_bc_br_h1v_h2v_b2v = $('#b1v_b2v_bc_br_h1v_h2v_b2v');
            var b1v_b2v_bc_br_h1v_h2v_bc = $('#b1v_b2v_bc_br_h1v_h2v_bc');
            var b1v_b2v_bc_br_h1v_h2v_br = $('#b1v_b2v_bc_br_h1v_h2v_br');
            var b1v_b2v_bc_br_h1v_h2v_essai = $('#b1v_b2v_bc_br_h1v_h2v_essai');
            var b1v_b2v_bc_br_h1v_h2v_verification = $('#b1v_b2v_bc_br_h1v_h2v_verification');
            var b1v_b2v_bc_br_h1v_h2v_mesurage = $('#b1v_b2v_bc_br_h1v_h2v_mesurage');
            var b1v_b2v_bc_br_h1v_h2v_h1v = $('#b1v_b2v_bc_br_h1v_h2v_h1v');
            var b1v_b2v_bc_br_h1v_h2v_h2v = $('#b1v_b2v_bc_br_h1v_h2v_h2v');
            var b1v_b2v_bc_br_h1v_h2v_hc = $('#b1v_b2v_bc_br_h1v_h2v_hc');
            /* uni_cnfsecrm - v2 - modif 115 - DEBUT */
            var b1v_b2v_bc_br_h1v_h2v_he = $('#b1v_b2v_bc_br_h1v_h2v_he');
            var b1v_b2v_bc_br_he = $('#b1v_b2v_bc_br_he');
            var bs_be_he_he = $('#bs_be_he_he');
            /* uni_cnfsecrm - v2 - modif 115 - FIN */
            if (b0_h0_h0v_b0.is(':checked')) {
                jQuery('#b0_h0_h0v_b0' + row_num).prop('checked', true);
            } else {
                jQuery('#b0_h0_h0v_b0' + row_num).prop('checked', false);
            }

            if (b0_h0_h0v_h0v.is(':checked')) {
                jQuery('#b0_h0_h0v_h0v' + row_num).prop('checked', true);
            } else {
                jQuery('#b0_h0_h0v_h0v' + row_num).prop('checked', false);
            }

            if (bs_be_he_b0.is(':checked')) {
                jQuery('#bs_be_he_b0' + row_num).prop('checked', true);
            } else {
                jQuery('#bs_be_he_b0' + row_num).prop('checked', false);
            }

            if (bs_be_he_h0v.is(':checked')) {
                jQuery('#bs_be_he_h0v' + row_num).prop('checked', true);
            } else {
                jQuery('#bs_be_he_h0v' + row_num).prop('checked', false);
            }

            if (bs_be_he_bs.is(':checked')) {
                jQuery('#bs_be_he_bs' + row_num).prop('checked', true);
            } else {
                jQuery('#bs_be_he_bs' + row_num).prop('checked', false);
            }

            if (bs_be_he_manoeuvre.is(':checked')) {
                jQuery('#bs_be_he_manoeuvre' + row_num).prop('checked', true);
            } else {
                jQuery('#bs_be_he_manoeuvre' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_b0.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_b0' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_b0' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h0v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h0v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h0v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_bs.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_bs' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_bs' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_manoeuvre.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_manoeuvre' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_manoeuvre' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_b1v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_b1v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_b1v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_b2v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_b2v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_b2v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_bc.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_bc' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_bc' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_br.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_br' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_br' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_essai.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_essai' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_essai' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_verification.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_verification' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_verification' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_mesurage.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_mesurage' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_mesurage' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_b0.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b0' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b0' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_h0v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h0v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h0v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_bs.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_bs' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_bs' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_manoeuvre.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_manoeuvre' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_manoeuvre' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_b1v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b1v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b1v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_b2v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b2v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_b2v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_bc.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_bc' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_bc' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_br.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_br' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_br' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_essai.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_essai' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_essai' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_verification.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_verification' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_verification' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_mesurage.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_mesurage' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_mesurage' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_h1v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h1v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h1v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_h2v.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h2v' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_h2v' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_hc.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_hc' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_hc' + row_num).prop('checked', false);
            }
            // uni_cnfsecrm - modif 104 - FIN

            /* uni_cnfsecrm - v2 - modif 115 - DEBUT */
            if (bs_be_he_he.is(':checked')) {
                jQuery('#bs_be_he_he' + row_num).prop('checked', true);
            } else {
                jQuery('#bs_be_he_he' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_he.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_he' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_he' + row_num).prop('checked', false);
            }

            if (b1v_b2v_bc_br_h1v_h2v_he.is(':checked')) {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_he' + row_num).prop('checked', true);
            } else {
                jQuery('#b1v_b2v_bc_br_h1v_h2v_he' + row_num).prop('checked', false);
            }
            /* uni_cnfsecrm - v2 - modif 115 - FIN */
            /* uni_cnfsecrm - v2 - modif 127 - DEBUT */
            $('#date_start_appr' + row_num).val($('#date_start_appr').val())
            $('#date_fin_appr' + row_num).val($('#date_fin_appr').val())
            $('#duree_jour' + row_num).val($('#duree_jour').val())
            $('#duree_heure' + row_num).val($('#duree_heure').val())
    ...
    registerEvents: function () {
        ...
        this.registerSelectAvisAttestationButton();
    }
});
