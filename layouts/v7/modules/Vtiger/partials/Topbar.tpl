...
{strip}
	...
	{assign var=APP_IMAGE_MAP value=Vtiger_MenuStructure_Model::getAppIcons()}
        {* uni_cnfsecrm - Add Modules Icons *}
        {assign var=USER_PRIVILEGES_MODEL value=Users_Privileges_Model::getCurrentUserPrivilegesModel()}
        {assign var=CALENDAR_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Calendar')}
        {* uni_cnfsecrm - elearning - DEBUT *}
        {assign var=GET_NBR_APPR_A_INSCRIR value=Vtiger_Module_Model::getNbreApprAInscrir()}
        {assign var=GET_NBR_APPR_ENCOURS_FORM value=Vtiger_Module_Model::getNbreApprEncourForm()}
        {assign var=GET_NBR_RV_A_PRENDRE value=Vtiger_Module_Model::getNbreRVAPrendre()}        
        {assign var=GET_NBR_RV_PRATIQUE value=Vtiger_Module_Model::getNbreRVPratique()}
        {assign var=GET_NBR_RAPPELS value=Vtiger_Module_Model::getNbreRappels()}        
        {assign var=GET_NBR_APPR_FINI_FORM value=Vtiger_Module_Model::getNbreApprFiniForm()}
        {* uni_cnfsecrm - elearning - FIN *}
	<nav class="navbar navbar-default navbar-fixed-top app-fixed-navbar">
		<div class="container-fluid global-nav">
			<div class="row">
                            <!-- unicnfsecrm_mod_66 -->
				<div class="col-lg-4 col-md-4 col-sm-4 app-navigator-container">
					<div class="row">
						...
						<div class="logo-container col-lg-2 col-md-2 col-sm-2 col-xs-2">
							<div class="row">
								<a href="index.php" class="company-logo">
									<img src="{$COMPANY_LOGO->get('imagepath')}" alt="{$COMPANY_LOGO->get('alt')}"/>
                                                ...
                                                {* uni_cnfsecrm - Add Modules Icons *}
                                                <div collapse navbar-collapse navbar-right global-actions>
                                                    <ul class="nav navbar-nav" style="float: none !important">
                                                        <li style="float: none !important">
                                                            <div style="padding-top: 13px;" class=" col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                                <a href="index.php?module=Accounts&amp;view=List&amp;app=MARKETING" title="Clients"><span class="module-icon"><i style="font-size: 17px;" class="vicon-accounts" title="Clients"></i></span></a>
                                                            </div>
                                                        </li>
                                                        <li style="float: none !important">
                                                            <div style="padding-top: 13px;" class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                                <a href="index.php?module=Contacts&amp;view=List&amp;app=MARKETING" title="Apprenants"><span class="module-icon"><i style="font-size: 17px;" class="vicon-contacts" title="Apprenants"></i></span></a>
                                                            </div>
                                                        </li>
                                                        <li style="float: none !important">
                                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                                <a style="font-size: 17px;" href="index.php?module=Calendar&amp;view=SharedCalendar" class="fa fa-calendar" title="Sessions" aria-hidden="true"></a>
                                                            </div>
                                                        </li>
                                                        <li style="float: none !important">
                                                            <div style="padding-top: 13px;" class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                               <a href="index.php?module=Invoice&amp;view=List&amp;app=INVENTORY" title="Factures"><span class="module-icon"><i style="font-size: 17px;" class="vicon-invoice" title="Factures"></i></span></a>
                                                            </div>
                                                        </li>
                                                        
                                                        {* uni_cnfsecrm - Change Session Icon *}
							<li style="float: none !important;">
                                                            <div style="padding-top: 13px;" class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                                <a href="index.php?module=Calendar&view={$CALENDAR_MODULE_MODEL->getDefaultViewName()}" title="{vtranslate('Calendar','Calendar')}"><span class="module-icon"><i style="font-size: 17px;" class="vicon-calendar" title="{vtranslate('Calendar','Calendar')}"></i></span></a>
                                                            </div>
                                                        </li>
				...
				<div class="search-links-container col-md-2 col-lg-2 hidden-sm">
					...
					<ul class="nav navbar-nav">
                                            {* uni_cnfsecrm - elearning - DEBUT *}
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="Liste des Stagiaires à inscrire" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=95&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_APPR_A_INSCRIR} </i>
                                                ...
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="Liste des Stagiaires en cours de formation" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=96&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_APPR_ENCOURS_FORM} </i>
                                                ...
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="Rendez-vous à prendre" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=101&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_RV_A_PRENDRE} </i>
                                                            <i class="far fa-calendar" style="font-size: 17px;"></i>
                                                        </a>
                                                    </div>
                                                </li>
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="La liste des Rendez-vous pratique" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=99&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_RV_PRATIQUE} </i>
                                                            <i class="far fa-calendar-check" style="font-size: 17px;"></i>
                                                        </a>
                                                    </div>
                                                </li>
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="Liste des rappels" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=98&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_RAPPELS} </i>
                                                ...
                                                <li style="margin-right: -40px;">
                                                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                        <a title="Liste des Stagiaires qui ont fini leurs formations" class="notification-popover" href="index.php?module=Apprenantselearning&parent=&page=&view=List&viewname=97&orderby=&sortorder=&app=TOOLS&tag_params=%5B%5D&nolistcache=0&list_headers=&tag=" >
                                                            <i style="font-size: 9px;background:red; position:relative; top: 7px; left: -7px; width: auto;" class="badge"> {$GET_NBR_APPR_FINI_FORM} </i>
                                                            <i class="fa fa-graduation-cap" style="font-size: 17px;"></i>
                                                        </a>
                                                    </div>
                                                </li>                                                                                                                                                                                                
                                                {* uni_cnfsecrm - elearning - FIN *}
