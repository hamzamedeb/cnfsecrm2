    ...
    <div class='quick-preview-modal modal-content'>
        <div class='modal-body'>
            ...
            <div class = "quickPreviewSummary">
                <input type="hidden" class="accountid" name="accountid" value="{$DETAIL['accountid']}">
                <input type="hidden" class="devisid" name="devisid" value="{$DETAIL['quoteid']}" >
                                    ...
                                    <td class="fieldValue col-lg-7">
                                        <div class="row">
                                            {if {$FIELD_NAME} == 'Nom & prenom'} 
                                                <span class="value textOverflowEllipsis"> <a href="index.php?module=Accounts&view=Detail&record={$DETAIL['accountid']}&app=MARKETING"> {$FIELD_MODEL} </a> </span>
                                            {elseif {$FIELD_NAME} == 'Devis'}
                                                <span class="value textOverflowEllipsis"> <a href="index.php?module=Quotes&view=Detail&record={$DETAIL['quoteid']}&app=SALES" > {$FIELD_MODEL} </a> </span>   
                                            {else}
                ...
                <table class="table" id="tableAction">
                    ...
                    <tr id="rowNew">
                        ...
                        <td class="reponseTd">
                            <select required onchange="SuiviProspects_Edit_Js.selectReponse(event,'')" class="form-control reponse">
                        ...
                        <td>
                            <button style="font-size: 20px;" class="btn btn-success pull-right" id="addRow" onclick="SuiviProspects_Edit_Js.addEditRow('save','')">+</button> 
                        </td>
                    </tr>
                </table>
                ...
                <table id="tableData" class="table">
                    {foreach item=FIELD_MODEL key=FIELD_NAME from=$DETAIL_HISTORIQUE}
                        <tr id="reponse{$FIELD_MODEL['id']}">
                            ...
                            <td><span onclick="SuiviProspects_Edit_Js.editRow({$FIELD_MODEL['id']})" class="fa fa-pencil"></span></td>
                        </tr>
                        <tr id="reponseedit{$FIELD_MODEL['id']}" class="hidden">
                            ...
                            <td class="reponseTd">
                                <select onchange="SuiviProspects_Edit_Js.selectReponse(event, {$FIELD_MODEL['id']})" class="form-control reponse">
                            ...
                            <td> <span onclick="SuiviProspects_Edit_Js.addEditRow('edit', {$FIELD_MODEL['id']})" class="pointerCursorOnHover input-group-addon input-group-addon-save"><i class="fa fa-check"></i></span> </td>
                            <td> <span onclick="SuiviProspects_Edit_Js.annulerEditRow({$FIELD_MODEL['id']})" class="pointerCursorOnHover input-group-addon input-group-addon-cancel"><i class="fa fa-close"></i></span> </td>
                        </tr>
                    {/foreach}
                </table>
