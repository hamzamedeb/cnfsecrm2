...
class Apprenantselearning_RecordQuickPreview_View extends Vtiger_RecordQuickPreview_View {
	...
	function process(Vtiger_Request $request) {
		...
		$moduleModel = $recordModel->getModule();
                ...
                /* -- */
                $detailApprenant = $recordModel->getDetailApprenant();
                $viewer->assign('DETAIL_APPRENANT',$detailApprenant);
                /* -- */
