...
class Livraison_Detail_View extends Vtiger_Index_View {
    ...
    public function getDetailHistorique($recordId) {
        ...
        $query = "SELECT livraisonid,productname,type,oldqty,newqty
                    FROM vtiger_history_livraison 
                    INNER JOIN vtiger_products on vtiger_products.productid = vtiger_history_livraison.productid
                    WHERE vtiger_history_livraison.livraisonid = ?";
