...
class Calendar_VendorsPopup_View extends Vtiger_Popup_View {
...
//                fclose($monfichier);
        ...
        $viewer->assign('MODULE', 'Calendar'); /* uni_cnfsecrm - resoudre problème recherche dans popup financeurs dans le module Session */
        ...
        $viewer->assign('VIEW', 'VendorsPopup');
        /* uni_cnfsecrm */
        $viewer->assign('GETURL', 'getFinanceursURL');
    }
    ...
    function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array('modules.Vendors.resources.Popup');
