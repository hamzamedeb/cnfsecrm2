...
class Calendar_ContactsPopup_View extends Vtiger_Popup_View {
...
//                fclose($monfichier);
        ...
        $viewer->assign('MODULE', 'Calendar'); /* uni_cnfsecrm - resoudre problème recherche dans popup apprenant dans le module Session */
        $viewer->assign('RELATED_MODULE', $moduleName);
        $viewer->assign('SOURCE_MODULE', $sourceModule);
        $viewer->assign('SOURCE_FIELD', $sourceField);
        $viewer->assign('SOURCE_RECORD', $sourceRecord);

//        $viewer->assign('SEARCH_KEY', "account_id");
//        $viewer->assign('SEARCH_VALUE', "45566");
