...
class Calendar_CalendarPopup_View extends Vtiger_Popup_View {
...
//        $viewer->assign('SEARCH_VALUE', "45566");
        ...
        $viewer->assign('VIEW', 'CalendarPopup');
        /* uni_cnfsecrm - return fonction getApprenantsURL */
        //$viewer->assign('GETURL', 'getCalendarURL');
    }
    ...
    function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array('modules.Calendar.resources.Popup');
