...
require_once('include/utils/SessionsApprenantsUtils.php');
require_once('include/utils/SessionsFinanceurUtils.php');
require_once('include/utils/SessionsDatesUtils.php');
...
class Activity extends CRMEntity {
    ...
    function save_module($module) {
        ...
        /* uni_cnfsecrm */
        saveSessionsApprenantDetails($this);
        saveSessionsDatesDetails($this);
        saveSessionsFinanceurDetails($this);
        /* uni_cnfsecrm */
    }
    ...
    function insertIntoActivityReminderPopup($cbmodule) {
     ...
     $monfichier = fopen('datedebug.txt', 'a+');
        fputs($monfichier, "\n" . ' cbtime :  '.$cbtime);
        fclose($monfichier);
