...
//unicnfsecrm_mod_56
/* uni_cnfsecrm - v2 - modif 142 - FILE */
require_once('modules/HistoryTokens/HistoryTokens.php');

class Calendar_ModifierTokensReaffecter_Action extends Vtiger_Action_Controller {
...
//            }
            ...
            $updateRel = "UPDATE vtiger_sessionsapprenantsrel SET type_tokens_reaffecter=?,ticket_examen_reaffecter=? WHERE id=? and apprenantid=?";
