...
/*uni_cnfsecrm - v2 - modif 166 - FIN*/
            if ($moduleName == "SalesOrder") {
                $detailViewLinks = array(
                    'linklabel' => vtranslate('LBL_EXPORT_CONVOCATION', $moduleName),
                    'linkurl' => $recordModel->getExportCONVOCATION(),
                    'linkicon' => ''
                );
                $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues($detailViewLinks);
                ...
                $detailViewLinks = array(
                    'linklabel' => vtranslate('LBL_EXPORT_SATISFACTION', $moduleName),
                    'linkurl' => $recordModel->getExportSATISFACTION(),
                    'linkicon' => ''
                );
                $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues($detailViewLinks);
            }
