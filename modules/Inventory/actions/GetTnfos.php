...
class Inventory_GetTnfos_Action extends Vtiger_Action_Controller {
    ...
    function process(Vtiger_Request $request) {
        ...
        foreach ($idList as $id) {
            ...
            /* unicnfsecrm_022020_18 */
            if (($email[$id] == null) || $email[$id] == '') {
                $emailClient[$id] = getSingleFieldValue("vtiger_account", "email1", "accountid", $recordModel->get('account_id'));
                $email[$id] = $emailClient[$id];
            }
        }
