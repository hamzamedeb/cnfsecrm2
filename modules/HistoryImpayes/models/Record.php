 ...
 */
class HistoryImpayes_Record_Model extends Vtiger_Record_Model {
    ...
    public function updateReminderHistoryImpayesStatus($status = 1) {
        $db = PearDatabase::getInstance();
        $db->pquery("UPDATE vtiger_historyimpayes set status = ? where 	historyimpayesid = ?", array($status, $this->getId()));
    }
