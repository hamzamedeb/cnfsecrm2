...
class Accounts_Record_Model extends Vtiger_Record_Model {
    ...
    public function getExportSIGNALETIQUE() {
        return "index.php?module=" . $this->getModuleName() . "&action=ExportSIGNALETIQUE&record=" . $this->getId()."&doc=SIGNALETIQUE";
    }

    /* unicnfsecrm_022020_20 */

    public function getSIGNALETIQUE($appr, $doc) {
        $recordId = $this->getId();
        $moduleName = $this->getModuleName();
        $controllerClassName = "Vtiger_EventsPDFController";
        ...
        $controller->OutputSIGNALETIQUE($fileName . '.pdf', 'I', $doc);
    }
