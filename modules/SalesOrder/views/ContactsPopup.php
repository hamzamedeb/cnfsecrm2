...
class SalesOrder_ContactsPopup_View extends Vtiger_Popup_View {
    ...
    public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
        ...
        $recherche = $request->get('search_value');
        $query = "SELECT vtiger_account.accountname FROM vtiger_account WHERE vtiger_account.accountid = ?";
        $result = $adb->pquery($query, array($recherche));
        $account = $adb->query_result($result, 'accountname');
        ...
        /* uni_cnfsecrm - recherche apprenants client sélectionné par popup */
        //$searchValue = $request->get('search_value'); // il faut le commenter
        $currencyId = $request->get('currency_id');
        $searchParams = $request->get('search_params');
        /* uni_cnfsecrm - recherche apprenants client sélectionné par popup */
        if ($account != '') {
            $searchParams[0][0][2] = $account;
        }
...
//                $monfichier = fopen('fichiertest.txt', 'a+');
//                fputs($monfichier, "\n" . "fournisseur ".$name);
//                fclose($monfichier);
        }
        ...
        $viewer->assign('VIEW', 'ContactsPopup');
        /* uni_cnfsecrm - return fonction getApprenantsURL */
        $viewer->assign('GETURL', 'getApprenantsURL');
    }
    ...
    function getHeaderScripts(Vtiger_Request $request) {
        ...
        $jsFileNames = array('modules.Contacts.resources.Popup');
