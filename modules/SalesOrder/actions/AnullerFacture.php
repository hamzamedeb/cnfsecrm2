...
class SalesOrder_AnullerFacture_Action extends Vtiger_Action_Controller {
        ...
        if (!is_null($apprenantId) && !is_null($recordId)) {
            ...
            if (!is_null($invoiceId)) {
                ...
                if (!is_null($idInvoice)) {
                    ...
                    $rectifierCompte = $adb->query_result($resultDetail2, 0, 'cf_1278');
                    ...
                    $adb->pquery($query, array($invoice_no_select_avoir, 'Avoir', $idInvoiceAvoir));
                    ...
                    $message = 'facture avoir est creer avec succses';
                ...
                $message = "pas de facture pour ce client";
                $resultAvoir = false;
            }
        } else {
            $message = "probleme d'ajout une facture avoir";
            $resultAvoir = false;
        }
