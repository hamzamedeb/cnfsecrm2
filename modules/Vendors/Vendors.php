...
class Vendors extends CRMEntity {
	...
	*/
	...
	function unlinkRelationship($id, $return_module, $return_id) {
        ...
        /* uni_cnfsecrm - v2 - modif 154 - DEBUT */
        function get_factures($id, $cur_tab_id, $rel_tab_id, $actions = false) {
        global $log, $singlepane_view, $currentModule, $current_user;
        ...
        $query = "SELECT case when (vtiger_users.user_name not like '') then $userNameSql else vtiger_groups.groupname end as user_name,
			...
			LEFT OUTER JOIN vtiger_vendor
				ON vtiger_vendor.vendorid = vtiger_invoice.financeur 
			LEFT JOIN vtiger_groups
				ON vtiger_groups.groupid = vtiger_crmentity.smownerid
