...
class Contacts_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		foreach($listViewEntries as $recordId => $record) {
			...
			$record['id'] = $recordId;
                        /* uni_cnfsecrm */
                        $rawData["accountname"] = getSingleFieldValue("vtiger_account", "accountname", "accountid", $rawData["accountid"]);
                        $rawData["numclient"] = getSingleFieldValue("vtiger_account", "account_no", "accountid", $rawData["accountid"]);                        
