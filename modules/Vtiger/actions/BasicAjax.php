...
class Vtiger_BasicAjax_Action extends Vtiger_Action_Controller {
    ...
    public function process(Vtiger_Request $request) {
        ...
        if ($searchModule != "ContactsByEvents") {
            ...
            fclose($monfichier);
            $searchModuleModel = Vtiger_Module_Model::getInstance("Contacts");
            $records = $searchModuleModel->searchRecord($searchValue, $parentRecordId, $parentModuleName, $relatedModule,'',$activityid);
        }
