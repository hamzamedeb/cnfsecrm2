...
class Vtiger_Widget_Model extends Vtiger_Base_Model {
	...
	public function getWidth() {
		$largerSizedWidgets = array('Impayes30Jours','GroupedBySalesPerson', 'PipelinedAmountPerSalesPerson', 'GroupedBySalesStage', 'Funnel Amount','Impayés7Jours','Impayés14Jours','ProchainesSessions'); 
		$title = $this->getName();
