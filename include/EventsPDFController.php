...
//			$contentViewer = new Vtiger_PDF_EventsContentViewer();
//		} else {
//			$contentViewer = new Vtiger_PDF_EventsTaxGroupContentViewer();
//		}
    ...
    function getFooterViewer() {
        $footerViewer = new Vtiger_PDF_EventsFooterViewer();
    ...
    function buildFooterModel() {
        ...
        $footerModel->set(Vtiger_PDF_EventsFooterViewer::$DESCRIPTION_DATA_KEY, from_html($this->focusColumnValue('description')));
        $footerModel->set(Vtiger_PDF_EventsFooterViewer::$TERMSANDCONDITION_DATA_KEY, from_html($this->focusColumnValue('terms_conditions')));
        return $footerModel;
    }

    function buildFooterLabelModel() {
        $labelModel = new Vtiger_PDF_Model();
        $labelModel->set(Vtiger_PDF_EventsFooterViewer::$DESCRIPTION_LABEL_KEY, getTranslatedString('Description', $this->moduleName));
        $labelModel->set(Vtiger_PDF_EventsFooterViewer::$TERMSANDCONDITION_LABEL_KEY, getTranslatedString('Terms & Conditions', $this->moduleName));
        return $labelModel;
    }
